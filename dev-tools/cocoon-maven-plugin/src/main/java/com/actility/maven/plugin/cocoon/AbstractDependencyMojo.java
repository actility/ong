...
public abstract class AbstractDependencyMojo extends AbstractMojo {
     ...
     *
     * @since 2.6
     * @parameter alias="dependency.useJvmChmod" default-value=""false"
     */
    ...
    protected void copyFile(File artifact, File destFile) throws MojoExecutionException {
        ...
        try {
            theLog.info("Copying " + (this.outputAbsoluteArtifactFilename ? artifact.getAbsolutePath() : artifact.getName())
                    + " to " + destFile);
