...
public final class DependencyUtil {
    ...
    /**
     * Builds the file name. If removeVersion is set, then the file name must be reconstructed from the artifactId, Classifier
     * (if used) and Type. Otherwise, this method returns the artifact file name.
     *
     ...
     * <b>prependGroupId</b> is true) artifactId, Classifier (if used) and Type. Otherwise, this method returns the artifact
     * file name.
     *
     * @param artifact File to be formatted.
     * @param removeVersion Specifies if the version should be removed from the file name.
