...
SHFLAGS="-nostdlib -Wl,-T,$LDSCRIPTS/armelf_linux_eabi.xsc -Wl,--gc-sections -Wl,-shared,-Bsymbolic -Wl,-rpath-link=$PLATFORM -L$PLATFORM/usr/lib -Wl,--no-whole-archive -lc -lm -Wl,--no-undefined $PREBUILT/lib/gcc/$AGCC_CXC/$AGCC_GCC/libgcc.a -Wl,--whole-archive -lgcc"	# .a, .o input files go *after* here
