...
//************************************************************************
//**
//** File : driver/m2m_zcl_0x0404_abstraction.h
//**
//** Description  :
//**
//**
...
#ifndef __M2M_ZCL_0x0404_ABSTRACTION__H_
#define __M2M_ZCL_0x0404_ABSTRACTION__H_

/**
 * @file m2m_zcl_0x0404_abstraction.h
 * @brief Gives the definition of a data and command interpreter for ZigBee Flow
 * Measurement cluster.
 * @author mlouiset
 * @date 2012-09-25
 */
...
/**
 * @struct m2mZcl0x0404Abstraction_t
 * @brief the generic definition of a data and command interpreter.
 */
typedef struct m2mZcl0x0404Abstraction_t
{
  /* generic methods */
  void (*free) (struct m2mZclAbstraction_t *);
  /** @ref m2mZcl0x0404Abstraction_t_getConsolidatedData */
