...
//************************************************************************
//**
//** File : driver/m2m_zcl_abstraction.h
//**
//** Description  :
//**
//**
...
#ifndef __M2M_ZCL_ABSTRACTION__H_
#define __M2M_ZCL_ABSTRACTION__H_

/**
 * @file m2m_zcl_abstraction.h
 * @brief Gives the general definition of a data and command interpreter for ZigBee clusters.
 * One need to inherite from this struct when implementing a data and command interpreter
 * specific to a ZigBee cluster.
 * @author mlouiset
 * @date 2012-09-25
 */

/**
 * @struct m2mZclAbstraction_t
 * @brief the generic definition of a data and command interpreter.
 */
typedef struct m2mZclAbstraction_t
{
  /* generic methods */
  /** @ref m2mZclAbstraction_t_newFree */
  void (*free) (struct m2mZclAbstraction_t *);
  /** @ref m2mZclAbstraction_t_getConsolidatedData */
  char *(*getConsolidatedData) (struct m2mZclAbstraction_t *This,
      azap_uint16 attrId, azapZclAttrVal_t *val);
  /** @ref m2mZclAbstraction_t_getZclAttribute */
  int (*getZclAttribute) (struct m2mZclAbstraction_t *This,
      zigbeeNode_t *node, azapEndPoint_t *ep, azap_uint16 attrId, int reqId);
  /** @ref m2mZclAbstraction_t_setZclAttribute */
  int (*setZclAttribute) (struct m2mZclAbstraction_t *This,
      zigbeeNode_t *node, azapEndPoint_t *ep, azap_uint16 attrId, void *obix,
      int reqId);
  /** @ref m2mZclAbstraction_t_doZclOperation */
  ...
  /** @ref m2mZclAbstraction_t_doZclOperationResp */
...
int  m2mZclAbstraction_t_doZclOperation(m2mZclAbstraction_t *This, azap_uint8 operation,
    zigbeeNode_t *node, azapEndPoint_t *ep, void *obixReqContent, int reqId);
void m2mZclAbstraction_t_doZclOperationResp(m2mZclAbstraction_t *This, azap_uint8 operation,
    azap_byte *cmdData, azap_uint8 cmdLen, int reqId);
