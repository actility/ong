...
//************************************************************************
//**
//** File : driver/m2m_zcl_0x0403_abstraction.c
//**
//** Description  :
//**
//**
...
/**
 * @brief Initialize the m2mZcl0x0403Abstraction_t struct
 * @param This the class instance
 */
static void m2mZcl0x0403Abstraction_t_init(m2mZcl0x0403Abstraction_t *This)
{
  RTL_TRDBG(TRACE_DETAIL, "m2mZcl0x0403Abstraction_t::init\n");

  /* Assign the pointers on functions */
  This->getConsolidatedData = m2mZcl0x0403Abstraction_t_getConsolidatedData;
  ...
  This->configureReporting = m2mZcl0x0403Abstraction_t_configureReporting;
  This->canReport = m2mZcl0x0403Abstraction_t_canReport;
...
/* dynamic allocation */
/**
 * @brief do dynamic allocation of a m2mZcl0x0403Abstraction_t.
 * @param epId the end point identifier.
 * @return the copy of the object
 */
m2mZcl0x0403Abstraction_t *new_m2mZcl0x0403Abstraction_t(azap_uint8 epId)
{
  m2mZcl0x0403Abstraction_t *This = malloc(sizeof(m2mZcl0x0403Abstraction_t));
  if (!This)
  {
    return NULL;
  }
  m2mZcl0x0403Abstraction_t_init(This);
  This->free = m2mZclAbstraction_t_newFree; // no changes

  This->endPointId = epId;
  This->clusterId = ZCL_CLUSTER_ID_MS_PRESSURE_MEASUREMENT;

  RTL_TRDBG(TRACE_DETAIL, "new m2mZcl0x0403Abstraction_t (id:0x%.2x.0x%.4x)\n",
...
/**
 * @brief Run the consolidation data method associated to PressureMeasurement cluster.
 * Where MeasuredValue = 10 x Pressure.
 ...
 */
char *m2mZcl0x0403Abstraction_t_getConsolidatedData(m2mZclAbstraction_t *This,
    azap_uint16 attrId, azapZclAttrVal_t *val)
{
  ...
  if ((ATTRID_MS_PRESSURE_MEASUREMENT_MEASURED_VALUE != attrId) &&
      (ATTRID_MS_PRESSURE_MEASUREMENT_TOLERANCE != attrId))
  {
    RTL_TRDBG(TRACE_INFO, "m2mZcl0x0403Abstraction_t::getConsolidatedData - warning: "
        "unsupported attribute 0x%.4x\n", attrId);
    return NULL;
  }

  if ( (((long long)0xFFFFFFFFFFFF8001LL) > val->getIntegerValue(val)) ||
 ...
 * @anchor m2mZcl0x0403Abstraction_t_configureReporting
 * @param This the class instance
 * @param cfgReportCmd the ZCL command that will be sent to the device.
 */
void m2mZcl0x0403Abstraction_t_configureReporting(m2mZclAbstraction_t *This,
 ...
 * @anchor m2mZcl0x0403Abstraction_t_canReport
 * @param This the class instance
 * @param attrId the attribute identifier on which we need a data consolidation.
 * @param return true if ZCL report can be forwarded to SCL, false otherwise.
 */
bool m2mZcl0x0403Abstraction_t_canReport(m2mZclAbstraction_t *This, azap_uint16 attrId)
{
  return true;
}
