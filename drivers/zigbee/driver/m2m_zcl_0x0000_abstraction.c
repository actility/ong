...
//************************************************************************
//**
//** File : driver/m2m_zcl_0x0000_abstraction.c
//**
//** Description  :
//**
//**
...
/**
 * @brief Initialize the m2mZcl0x0000Abstraction_t struct
 * @param This the class instance
 */
static void m2mZcl0x0000Abstraction_t_init(m2mZcl0x0000Abstraction_t *This)
{
  RTL_TRDBG(TRACE_DETAIL, "m2mZcl0x0000Abstraction_t::init\n");
  ...
  This->doZclOperation = m2mZcl0x0000Abstraction_t_doZclOperation;
...
/* dynamic allocation */
/**
 * @brief do dynamic allocation of a m2mZcl0x0000Abstraction_t.
 * @anchor new_m2mZcl0x0000Abstraction_t
 * @param epId the end point identifier.
 * @return the copy of the object
 */
m2mZcl0x0000Abstraction_t *new_m2mZcl0x0000Abstraction_t(azap_uint8 epId)
{
  m2mZcl0x0000Abstraction_t *This = malloc(sizeof(m2mZcl0x0000Abstraction_t));
  if (!This)
  {
    return NULL;
  }
  m2mZcl0x0000Abstraction_t_init(This);
  This->free = m2mZclAbstraction_t_newFree; // no changes

  This->endPointId = epId;
  This->clusterId = ZCL_CLUSTER_ID_GEN_BASIC;

  RTL_TRDBG(TRACE_DETAIL, "new m2mZcl0x0000Abstraction_t (id:0x%.2x.0x%.4x)\n",
 ...
 * @anchor m2mZcl0x0000Abstraction_t_doZclOperation
 * @param This the class instance
 ...
 */
int m2mZcl0x0000Abstraction_t_doZclOperation(m2mZclAbstraction_t *This,
    ...
    int reqId)
{
  ...
  if (COMMAND_BASIC_RESET_FACT_DEFAULT != operation)
  {
    RTL_TRDBG(TRACE_INFO, "m2mZcl0x0000Abstraction_t_doZclOperation - warning: unsupported "
        "ZCL operation (0x%.2x)\n", operation);
    return ERR_UNSUPPORTED_OPERATION;
  }
  // COMMAND_BASIC_RESET_FACT_DEFAULT is the only command supported; one does not
  // expect any response to this command. So no issuerContext provided.
  if (! azapZclOutgoingCmdReq(azapPort, AZAP_REQ_TTL_START_AT_API, NULL,
      ...
      ZCL_FRAME_CLIENT_SERVER_DIR, false, COMMAND_BASIC_RESET_FACT_DEFAULT, 0, NULL, 0))
  {
