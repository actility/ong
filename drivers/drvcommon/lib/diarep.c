...
void DIA_LEAK WDiaUCBRequestOk_DiaRepOk(t_dia_req *preq, t_cmn_sensor *cmn) {}

int DIA_LEAK WDiaUCBPreLoadTemplate_DiaRepInstCreate(t_dia_req *preq, char *target, t_cmn_sensor *cmn, void **xo,char *templ)
{
    return 0;
}
int DIA_LEAK WDiaUCBPreLoadTemplate_DiaRepContCreate(t_dia_req *preq, char *target, t_cmn_sensor *cmn, void **xo,char *templ)
{
    return 0;
}
int DIA_LEAK WDiaUCBPreLoadTemplate_DiaRepElemCreate(t_dia_req *preq, char *target, t_cmn_sensor *cmn, void **xo,char *templ)
{
    return 0;
}
int DIA_LEAK WDiaUCBPostLoadTemplate_DiaRepInstCreate(t_dia_req *preq, char *target, t_cmn_sensor *cmn, void *xo)
{
    return 0;
}
int DIA_LEAK WDiaUCBPostLoadTemplate_DiaRepContCreate(t_dia_req *preq, char *target, t_cmn_sensor *cmn, void *xo)
{
    return 0;
}
int DIA_LEAK WDiaUCBPostLoadTemplate_DiaRepElemCreate(t_dia_req *preq, char *target, t_cmn_sensor *cmn, void *xo)
{
    return 0;
}
...
static	void	DiaRepOk(t_dia_req *preq,t_dia_rspparam *par)
{
	...
	WDiaUCBRequestOk_DiaRepOk(preq,cmn);
}
...
retry	:
	...
	{ // xo load + UCB are called only for new requests
		...
		WDiaUCBPreLoadTemplate_DiaRepInstCreate(preq,target,cmn,&xo,tmp);
		if	(!xo)
		{
		...
		WDiaUCBPostLoadTemplate_DiaRepInstCreate(preq,target,cmn,xo);
	}
...
void	DiaReportValue(int dev,int serial,int app,int cluster,int attr,int member,char *fmt,...)
{
	...
	RQT_UNSET_UPDATE_ELEM(&req);
	RQT_UNSET_UPDATE_CONT(&req);
