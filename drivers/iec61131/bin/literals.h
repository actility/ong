...
extern param_ret_t *getLiteral(char *str);
extern char *DATE2String(IEC_DATE d);
extern char *TOD2String(IEC_TOD tod);
extern char *DT2String(IEC_DT dt);
