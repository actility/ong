...
##                    "generate" : generate_block, "initialise" : initialise_block}
              ...
              {"name" : _("ACTILITY function blocks"), "list":
               [{"name" : "WAVE_GENERATOR", "type" : "functionBlock", "extensible" : False, 
                    "inputs" : [("Average","REAL","none"),("Amplitude","REAL","none"),("Period","REAL","none"),("SigType","INT","none")], 
                    "outputs" : [("Value","REAL","none")],
                    "comment" : _("Sensor Simulator\nSensor simulator generates sin(1),square(2),triangle(3),  sawTooth(4)."),
                    "generate" : generate_block, "initialise" : initialise_block},
                {"name" : "SQUAREWAVE_GENERATOR", "type" : "functionBlock", "extensible" : False, 
                "inputs" : [("Period","REAL","none")], 
                "outputs" : [("Value","BOOL","none")],
                "comment" : _("Square Wave generator\nGenerates a square wave based on the Period value (in Sec.)"),
                "generate" : generate_block, "initialise" : initialise_block},
                {"name" : "PWM_GENERATOR", "type" : "functionBlock", "extensible" : False,
                "inputs" : [("Start","BOOL","none"),("ResetMode","DINT","none"),("Period","TIME","none"),("Ratio","DINT","none"),("Limit_High","DINT","none"),("Limit_Low","DINT","none")],
                "outputs" : [("PWM_Out","BOOL","none")],
                "comment" : _("PWM generator\nGenerates a PWM based on the fixed Period value and the given ratio in percent (%)"),
                "generate" : generate_block, "initialise" : initialise_block},
                ]},
             ]
