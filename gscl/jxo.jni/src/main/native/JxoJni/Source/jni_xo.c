...
JNIEXPORT jint JNICALL Java_com_actility_m2m_xo_jni_JniXo_init(JNIEnv * env,
    jclass class)
{
  XoInit(0);
  XoVersion();
...
JNIEXPORT jboolean JNICALL Java_com_actility_m2m_xo_jni_JniXo_start(
    JNIEnv * env, jclass class, jstring xoNamespacesFile, jstring xoRefFile,
    jstring dictFile)
{
  ...
  if (xoExceptionClass != NULL)
  {
    ...
    if (xoExceptionClass == NULL)
    {
      jresult = JNI_FALSE;
      printf(
          "Cannot get a global reference on com.actility.m2m.xo.XoException");
    }
  }
  else
  {
  ...
  xoParseExceptionClass = (*env)->FindClass(env,
      "com/actility/m2m/xo/XoParseException");
  if (xoParseExceptionClass != NULL)
  {
    ...
    if (xoParseExceptionClass == NULL)
    {
      jresult = JNI_FALSE;
      printf(
          "Cannot get a global reference on com.actility.m2m.xo.XoParseException");
    }
  }
  else
  {
  ...
  xoUnknownTypeExceptionClass = (*env)->FindClass(env,
      "com/actility/m2m/xo/XoUnknownTypeException");
  if (xoUnknownTypeExceptionClass != NULL)
  {
    xoUnknownTypeExceptionClass = (*env)->NewGlobalRef(env,
        xoUnknownTypeExceptionClass);
    if (xoUnknownTypeExceptionClass == NULL)
    {
      jresult = JNI_FALSE;
      printf(
          "Cannot get a global reference on com.actility.m2m.xo.XoUnknownTypeException");
    }
  }
  else
  {
    jresult = JNI_FALSE;
    printf(
        "Cannot get a reference on com.actility.m2m.xo.XoUnknownTypeException");
  }
  illegalStateExceptionClass = (*env)->FindClass(env,
      "java/lang/IllegalStateException");
  if (illegalStateExceptionClass != NULL)
  {
    illegalStateExceptionClass = (*env)->NewGlobalRef(env,
        illegalStateExceptionClass);
    if (illegalStateExceptionClass == NULL)
    {
      jresult = JNI_FALSE;
      printf(
          "Cannot get a global reference on java.lang.IllegalStateException");
    }
  }
  else
  {
  ...
  if (initialized == 0)
  {
    ...
    if (xoNamespacesFile != NULL)
    {
      ...
      char* cXoNamespacesFile = (char*) (*env)->GetStringUTFChars(env,
          xoNamespacesFile, 0);
...
JNIEXPORT void JNICALL Java_com_actility_m2m_xo_jni_JniXo_stop(JNIEnv * env,
    jclass class)
{
...
(JNIEnv * env, jclass class, jlong xoHandle, jstring attributeName, jboolean obix)
{
  ...
  if (buffer != NULL)
  {
    ...
    void* xoObject = xoObject = XoReadXmlMem(buffer, bufferLength, NULL, flags, &result);
...
(JNIEnv * env, jclass class, jlong xoHandle, jstring path, jboolean obix)
{
  ...
  if (buffer != NULL)
  {
    ...
    void* xoObject = xoObject = XoReadExiMem(buffer, bufferLength, NULL, flags, &result);
    ...
    JNIEnv * env, jclass class, jbyteArray rawObject, jboolean obix)
{
  ...
  {
    throwXoUnknownTypeException(env, 64, "XoReadXmlMem() unknown type error=%d",
        result);
  }
  return (jint) xoObject;
}
    ...
    JNIEnv * env, jclass class, jbyteArray rawObject, jstring rootType)
{
  ...
  xoObject = XoReadXmlMem(buffer, bufferLength, cRootType, XOML_PARSE_TARGET,
      &result);
  if (rootType != NULL)
  {
    (*env)->ReleaseStringUTFChars(env, rootType, cRootType);
...
JNIEXPORT jint JNICALL Java_com_actility_m2m_xo_jni_JniXo_xoNmNew(JNIEnv * env,
    jclass class, jstring type)
{
  //void *XoNmNew(char* nameclass)
  char* cType = (char*) (*env)->GetStringUTFChars(env, type, 0);
  void* obj = XoNmNew(cType);
    ...
    jboolean obix)
{
  ...
  if (buffer != NULL)
  {
    ...
    void* xoObject = xoObject = XoReadXmlMem(buffer, bufferLength, NULL, flags,
        &result);
    ...
    jboolean obix)
{
  ...
  if (buffer != NULL)
  {
    ...
    void* xoObject = xoObject = XoReadExiMem(buffer, bufferLength, NULL, flags,
        &result);
...
JNIEXPORT jbyteArray JNICALL Java_com_actility_m2m_xo_jni_JniXo_xoWriteXmlMem(
    JNIEnv * env, jclass class, jint xoHandle, jstring defaultNamespace,
    jboolean obix)
{
  //void *XoWritXmlMem(void *obj,int32 flags,char **bufout,char *defns);
  jbyteArray rawObject = NULL;
  ...
  char* cDefaultNamespace = (char*) (*env)->GetStringUTFChars(env,
      defaultNamespace, 0);
  w = XoWritXmlMem((void*) xoHandle, flags, &buffer, cDefaultNamespace);
  (*env)->ReleaseStringUTFChars(env, defaultNamespace, cDefaultNamespace);
  if (w)
    ...
    jstring defaultNamespace)
{
  ...
  case BASIC_ATTR:
    ...
    XoNmSetAttr(tmpObject, attr, attrValue, 0);
    XoNmSetAttr(tmpObject, XOML_BALISE_ATTR, "<", 0);
    rawObject = Java_com_actility_m2m_xo_jni_JniXo_xoWriteXmlMem(env, class,
        (jint) tmpObject, defaultNamespace, JNI_FALSE);
    XoFree(tmpObject, 1);
    break;
  case OBJ_ATTR:
    XoSetNameSpace(attrValue, NULL);
    rawObject = Java_com_actility_m2m_xo_jni_JniXo_xoWriteXmlMem(env, class,
        (jint) attrValue, defaultNamespace, JNI_FALSE);
    XoUnSetNameSpace(attrValue, NULL);
    break;
  case LIST_OBJ_ATTR:
  case LIST_BASIC_ATTR:
    ...
    JNIEnv * env, jclass class, jint xoHandle)
{
  ...
  xoLength = XoSaveMemAllocFlg((void*) xoHandle, &buffer, &bufferLength,
      XO_SHARED_DICO | XO_COMPRESS_0);
  if (buffer != NULL)
  {
    rawObject = (*env)->NewByteArray(env, xoLength);
    ...
    JNIEnv * env, jclass class, jint xoHandle, jstring attributeName)
{
  ...
  jbyteArray buffer = NULL;
  int bufferLength = 0;
  void* attrValue = XoNmGetAttr((void*) xoHandle, cAttributeName,
      &bufferLength);
  (*env)->ReleaseStringUTFChars(env, attributeName, cAttributeName);
  if (attrValue != NULL)
  {
    buffer = (*env)->NewByteArray(env, bufferLength);
    (*env)->SetByteArrayRegion(env, buffer, 0, bufferLength,
        (jbyte*) attrValue);
  }
  return buffer;
}
    ...
    jint xoHandleValue)
{
  ...
  char* cAttributeName = (char*) (*env)->GetStringUTFChars(env, attributeName,
      0);
  jint result = (jint) XoNmAddInAttr((void*) xoHandle, cAttributeName,
      (void*) xoHandleValue, 0);
  (*env)->ReleaseStringUTFChars(env, attributeName, cAttributeName);
    ...
    jstring value)
{
  ...
  char* cAttributeName = (char*) (*env)->GetStringUTFChars(env, attributeName,
      0);
  char* cValue = (char*) (*env)->GetStringUTFChars(env, value, 0);
  jint result = (jint) XoNmAddInAttr((void*) xoHandle, cAttributeName, cValue,
      0);
  (*env)->ReleaseStringUTFChars(env, value, cValue);
  (*env)->ReleaseStringUTFChars(env, attributeName, cAttributeName);
...
JNIEXPORT jint JNICALL Java_com_actility_m2m_xo_jni_JniXo_xoFree(JNIEnv * env,
    jclass class, jint xoHandle, jboolean cascadeMode)
{
  //int32 XoFree (void *obj , int32 reccur );
  return (jint) XoFree((void*) xoHandle, (int) cascadeMode);
}
...
JNIEXPORT jbyteArray JNICALL Java_com_actility_m2m_xo_jni_JniXo_xoWriteXmlMem64(
    JNIEnv * env, jclass class, jlong xoHandle, jstring defaultNamespace,
    jboolean obix)
{
  return NULL;
}
...
JNIEXPORT jint JNICALL Java_com_actility_m2m_xo_jni_JniXo_xoFree64(JNIEnv * env,
    jclass class, jlong xoHandle, jboolean cascadeMode)
{
  return (jint) 0;
}
