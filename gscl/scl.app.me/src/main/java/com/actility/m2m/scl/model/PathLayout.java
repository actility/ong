 ...
 * 
 * id $Id: PathLayout.java 3302 2012-10-10 14:19:16Z JReich $
...
public interface PathLayout {
    ...
    PathLayout getSubLayout(String name);
    int getAttributeId(String name);
    PathLayout getWildcardLayout();
    int getResourceId();
    int getDefaultResourceId();
    int getResourceIdFromTag(String tag, String attribute);
    int getRetrieveMode();
}
