...
public interface LongPollingClientStats {
    ...
    long getAccOfBadRequestEndContactRequests();
    ...
    long getAccOfErrorEndContactResponses();
    ...
    long getAccOfEmptyEndLongPollingRequests();

    long getAccOfErrorEndLongPollingRequests();

    long getAccOfExceptionEndLongPollingRequests();
