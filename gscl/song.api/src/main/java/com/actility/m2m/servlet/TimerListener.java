 ...
 * 
 * id $Id: TimerListener.java 6081 2013-10-15 13:33:50Z mlouiset $
...
/**
 * Listener interface implemented by servlet applications using timers. An application must declare and register this Listener
 * to receive expiration events. There may be at most one TimerListener defined.
 *
 * @see TimerService
 */
