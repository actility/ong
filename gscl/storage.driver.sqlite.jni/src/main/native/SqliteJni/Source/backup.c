...
int backupDb(JNIEnv *env, jobject jobj,
...
SWIGEXPORT jint JNICALL Java_com_actility_m2m_storage_driver_sqlite_ni_impl_SqliteDriverJNIService_backupDb(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jint jarg3, jint jarg4)
{
  jint jresult = 0 ;
