 ...
 * 
 * id $Id: InOut.java 6058 2013-10-14 12:01:59Z mlouiset $
...
public interface InOut extends MessageExchange {
    ...
    /**
     * Retrieves the <i>in</i> Backend message from this exchange.
     * 
     * @return in message
     */
    ...
    /**
     * Retrieves the <i>out</i> Backend message from this exchange.
     * 
     * @return out message
     */
    BackendMessage getOutMessage();

    /**
     * Sets the <i>in</i> Backend message for this exchange.
     * 
    ...
    /**
     * Sets the <i>out</i> Backend message for this exchange.
     * 
     * @param msg out message
     * @throws MessagingException unable to set out message
     */
    void setOutMessage(BackendMessage msg) throws MessagingException;
