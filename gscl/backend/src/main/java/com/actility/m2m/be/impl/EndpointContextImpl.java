 ...
 * 
 * id $Id: EndpointContextImpl.java 6060 2013-10-14 12:13:03Z mlouiset $
...
public final class EndpointContextImpl implements EndpointContext {

    private final DeliveryChannelImpl deliveryChannel;
    private final int id;

    public EndpointContextImpl(int id, DeliveryChannelImpl deliveryChannel) {
        this.id = id;
