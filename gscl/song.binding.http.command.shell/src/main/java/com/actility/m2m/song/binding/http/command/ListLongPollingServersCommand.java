...
public final class ListLongPollingServersCommand implements Command {

    private final BundleContext context;

    public ListLongPollingServersCommand(BundleContext context) {
        this.context = context;
    }

    public String getName() {
        return "http-lslpservers";
    }
    ...
    public String getShortDescription() {
        return "Gets the list of long polling server ids";
    }
    ...
    public void execute(String line, PrintStream out, PrintStream err) {
        ...
        List ids = songHttpBindingStatsService.listLongPollingServers();
